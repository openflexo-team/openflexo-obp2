...
public class CreateBasicOBP2AnalysisWizard extends AbstractCreateVirtualModelInstanceWizard<CreateBasicOBP2Analysis> {

	@SuppressWarnings("unused")
	private static final Logger logger = Logger.getLogger(CreateBasicOBP2AnalysisWizard.class.getPackage().getName());

	public CreateBasicOBP2AnalysisWizard(CreateBasicOBP2Analysis action, FlexoController controller) {
		super(action, controller);
	}

	@Override
	public String getWizardTitle() {
		return getAction().getLocales().localizedForKey("create_obp2_analysis");
	}

	@Override
	public Image getDefaultPageImage() {
		return IconFactory.getImageIcon(OBP2IconLibrary.OBP2_TA_BIG_ICON, IconLibrary.BIG_NEW_MARKER).getImage();
	}
	...
	public class ChooseAndConfigureCreationSchemeForVirtualModel extends AbstractChooseAndConfigureCreationScheme {
		...
		public ChooseAndConfigureCreationSchemeForVirtualModel() {
			super(CreateBasicOBP2AnalysisWizard.this.getAction().getCreationSchemeAction());
		}
