...
package org.openflexo.ta.obp2.controller.action;
...
public class CreateBasicOBP2AnalysisInitializer extends ActionInitializer<CreateBasicOBP2Analysis, FlexoObject, FlexoObject> {

	@SuppressWarnings("unused")
	private static final Logger logger = Logger.getLogger(ControllerActionInitializer.class.getPackage().getName());

	public CreateBasicOBP2AnalysisInitializer(ControllerActionInitializer actionInitializer) {
		super(CreateBasicOBP2Analysis.actionType, actionInitializer);
	}

	@Override
	protected FlexoActionRunnable<CreateBasicOBP2Analysis, FlexoObject, FlexoObject> getDefaultInitializer() {
		return (e, action) -> {
	...
	@Override
	protected FlexoActionRunnable<CreateBasicOBP2Analysis, FlexoObject, FlexoObject> getDefaultFinalizer() {
		return (e, action) -> {
	...
	@Override
	protected FlexoExceptionHandler<CreateBasicOBP2Analysis, FlexoObject, FlexoObject> getDefaultExceptionHandler() {
	...
	@Override
	protected Icon getEnabledIcon(FlexoActionFactory<CreateBasicOBP2Analysis, FlexoObject, FlexoObject> actionType) {
