...
package org.openflexo.ta.obp2.model.fml;
...
public class OBP2FMLModelFactoryIntegrationTest extends AbstractModelFactoryIntegrationTestCase {

	private static final Logger logger = FlexoLogger.getLogger(OBP2FMLModelFactoryIntegrationTest.class.getPackage().getName());
	...
	public void initializeServiceManager() {
		...
		assertNotNull(taService.getTechnologyAdapter(OBP2TechnologyAdapter.class));
	}
