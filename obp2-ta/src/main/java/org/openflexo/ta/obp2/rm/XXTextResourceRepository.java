 ...
 */
@ModelEntity
public interface XXTextResourceRepository<I> extends TechnologyAdapterResourceRepository<XXTextResource, OBP2TechnologyAdapter, XXText, I> {

	public static <I> XXTextResourceRepository<I> instanciateNewRepository(OBP2TechnologyAdapter technologyAdapter,
